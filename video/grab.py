...
ap.add_argument("--port", type=int, default=60050)
ap.add_argument("--region", type=str, default="0,52,300,412")
...
while True:
    ...
    encode_param = [int(cv2.IMWRITE_PNG_COMPRESSION), args.quality]
